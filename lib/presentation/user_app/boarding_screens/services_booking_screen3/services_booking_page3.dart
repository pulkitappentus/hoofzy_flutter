...
class ServicesBookingPage3 extends BaseView<HomeController> {
  ...
  static const LatLng _center = LatLng(26.8549, 75.8243);
  ...
  Widget body(BuildContext context) {
    return Stack(
      children: [
        ...
        Padding(
          padding: const EdgeInsets.only(top: 56.0,left: 20.0),
          child: Align(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: const Icon(Icons.close,color: Colors.black, size: 26.0),
              ),
            ),
          ),
        ),
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            child: const Align(alignment:Alignment.center,child: Text('Book Now',style: textWhiteMedium16,)),
