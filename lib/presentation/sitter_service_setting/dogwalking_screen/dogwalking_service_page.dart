...
class DogwalkingServicePage extends BaseView<BoardingServiceController> {
              ...
              child: Column(
                children: <Widget> [
                  const Padding(
                    ...
                    child: Align(alignment: Alignment.topLeft,child: Text('Dog Walking',style: headlineBlack20,)),
                  ),

                  const Padding(
                    padding: const EdgeInsets.only(left: 16.0,top: 15,right: 16),
                    child: Align(alignment: Alignment.topLeft,
                      child: Text('Dog walks that fit your schedule',style:
