...
class DoggycareServicePage extends BaseView<BoardingServiceController> {
              ...
              child: Column(
                children: <Widget> [
                  const Padding(
                    ...
                    child: Align(alignment: Alignment.topLeft,child: Text('Doggy Day Care',style: headlineBlack20,)),
                  ),

                  const Padding(
                    padding: const EdgeInsets.only(left: 16.0,top: 15,right: 16),
                    child: Align(alignment: Alignment.topLeft,
                      child: Text('Daytime pet care in your home',style:
