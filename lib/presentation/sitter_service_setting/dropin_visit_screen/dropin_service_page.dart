...
class DropinServicePage extends BaseView<BoardingServiceController> {
              ...
              child: Column(
                children: <Widget> [
                  const Padding(
                    ...
                    child: Align(alignment: Alignment.topLeft,child: Text('Drop-In Visit',style: headlineBlack20,)),
                  ),

                  const Padding(
                    padding: const EdgeInsets.only(left: 16.0,top: 15,right: 16),
                    child: Align(alignment: Alignment.topLeft,
                      child: Text('Potty breaks and play dates',style:
